...
## 2.4 Live Server 실행
- VS Code에서 Explorer 창의 05_javascript 폴더에서 마우스 오른쪽 버튼 클릭 후 Open in Integrated Terminal 선택
```sh
...
## 5.1 숫자 리터럴
- 정수: `10`
- 실수: `3.14`ex05-01.html:12 Uncaught ReferenceError: Cannot access 'str3' before initialization
  at ex05-01.html:12:37
- 지수 표기법: `1e3`
...
- 💻 실습 (05-01 변수 선언과 리터럴): [ex02-03.html](../workspace/05_javascript/ex05-01.html)
...
console.log(typeof user, user); // object { name: 'kharuim', age: 6, job: 'sleep', married: false }
```
